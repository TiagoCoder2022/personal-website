export const projects = [
  {
    ...
    description:
      "This specialized e-commerce presents a wide range of computer peripherals, covering essential items such as mouses, keyboards, monitors, mousepads, headsets and speakers.",
    features: [
      "✅ Login with Google",
      "✅ Navigation categories",
      "✅ Products descouts",
      "✅ Shopping Cart Management",
      "✅ Payment for Orders with Stripe API",
    ],
    tags: [
      "React.js",
      "Next.js",
  ...
  },
  {
    ...
    subtitle: "Full-Stack Project",
    description:
      "This is a Fullstack project for a travel and accommodation search webpage. Every aspect, from the user interface to order processing and payment integration, has been meticulously crafted to ensure quality, usability and security for users.",
    features: [
      "✅ Login with Google",
      "✅ Navigation categories",
  ...
  },
  {
    ...
    subtitle: "Full-Stack Project",
    description:
      "Finance AI is a financial management SaaS application designed to help people manage and organize their finances and gain valuable insights with AI.",
    features: [
      "✅ Intelligent reporting powered by AI (ChatGPT)",
      "✅ Integration with Stripe for payments",
      "✅ Secure authentication with Google and Clerk",
      "✅ Presentational home page to highlight key features",
      "✅ Plans management",
    ],
    tags: [
      "React.js",
  ...
  },
  {
    ...
    features: [
      ...
      "✅ View accesses to the link by the registrant's ID",
      "✅ User ranking",
      "✅ Responsiveness",
    ],
    tags: [
